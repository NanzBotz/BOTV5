...
❏ *Bio Bot* : ${ppstatus.status}\n\n*Support/Subscribe Me*\n_https://youtube.com/c/BroKenzchannelOfficial`, quoted: m, sendEphemeral: true, thumbnail: fs.readFileSync('./src/error.png'), contextInfo: { mentionedJid: [global.conn.user.jid]}})
}
handler.help = ['alive']
handler.tags = ['main']
